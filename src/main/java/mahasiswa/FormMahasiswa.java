...
public class FormMahasiswa extends javax.swing.JFrame {
    ...
    private void loadData() {
        ...
        try (Connection con = db.koneksi();
             ...
             ResultSet rs = st.executeQuery(
                 "SELECT m.nim, m.nama, m.angkatan, p.nama_prodi " +
                 "FROM mahasiswa m " +
            ...
            while (rs.next()) {
                model.addRow(new Object[]{
                    rs.getString("nim"),
                    rs.getString("nama"),
                    rs.getString("angkatan").substring(0, 4),
    ...
    private void EditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditActionPerformed
        ...
        if (baris == -1) {
            javax.swing.JOptionPane.showMessageDialog(this,
                "Pilih mahasiswa yang ingin diedit!",
                "Peringatan", javax.swing.JOptionPane.WARNING_MESSAGE);
            return;
        }

        String nim      = (String) jTable1.getValueAt(baris, 0);
        String nama     = (String) jTable1.getValueAt(baris, 1);
        String angkatan = (String) jTable1.getValueAt(baris, 2);
        String prodi    = (String) jTable1.getValueAt(baris, 3);

//        new EditMahasiswa(nim, nama, angkatan, prodi).setVisible(true);
        new EditMahasiswa(nim, nama, angkatan, prodi).setVisible(true);
        this.dispose();
    ...
    private void HapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_HapusActionPerformed
        ...
        try (Connection con = db.koneksi();
            ...
            ps.executeUpdate();
            javax.swing.JOptionPane.showMessageDialog(this,
                "Mahasiswa berhasil dihapus!", "Sukses",
